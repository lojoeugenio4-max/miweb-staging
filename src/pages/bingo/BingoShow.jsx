...
export default function BingoShow() {
  ...
  const moving = ["starting", "spinning"].includes(phase);
  const extracting = ["extracting", "landed"].includes(phase);
  const status = phase === "starting" ? "MOTOR EN MARCHA" : phase === "spinning" ? "MEZCLANDO LAS 90 BOLAS" : phase === "stopping" ? "BOLAS DETENIDAS" : phase === "extracting" ? "EXTRAYENDO BOLA" : phase === "landed" ? "BOLA EN EL RECIPIENTE" : phase === "reveal" ? "NUEVA BOLA" : displayNumber ? "ÚLTIMA BOLA CANTADA" : "TODO PREPARADO";
        ...
        <div className="pro-machine">
          ...
          <div className="pro-frame">
            ...
            <div className={`pro-chute ${extracting ? `is-active is-${phase}` : ""}`}>
              ...
              <div className="pro-chute__glass" />
