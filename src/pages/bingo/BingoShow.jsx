...
export default function BingoShow() {
  ...
  async function drawFromQr() {
    ...
    setDrawing(true);
    setError("");
    setDrawMessage("Extrayendo bola…");
    ...
    if (drawError || !result?.ok) {
      setDrawing(false);
      setDrawMessage("");
      setError(result?.message || drawError?.message || "No se pudo extraer la bola.");
      return;
    }
