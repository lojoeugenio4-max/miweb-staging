    ...
    function draw(now) {
      ...
      balls.forEach((ball, index) => {
        ...
        if (spinStrength > 0.001) {
          // Volteo de arriba abajo: la fuerza principal sigue el plano vertical del bombo.
          const tumble = (0.00072 + (index % 7) * 0.000028) * spinStrength;
          ball.vx += ball.y * tumble * 0.38 * dt;
          ball.vy += -ball.x * tumble * 1.45 * dt;
          ball.vx += Math.sin(rotation * 3.1 + index * 0.63) * 0.00022 * spinStrength * dt;
          ball.vy += Math.cos(rotation * 2.5 + index * 0.81) * 0.00044 * spinStrength * dt;
        }
